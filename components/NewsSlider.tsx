  ...
  return (
    <div className="relative max-w-5xl mx-auto">
      <Link href={`/news/${currentItem.slug}`}>
        <div className="relative h-80 md:h-96 bg-white rounded-3xl overflow-hidden border border-light-200 shadow-xl cursor-pointer hover:shadow-2xl transition-shadow duration-300">
          {/* 背景パターン */}
